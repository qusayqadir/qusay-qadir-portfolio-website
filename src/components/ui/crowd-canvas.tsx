...
// Animated crowd of walking people drawn on an HTML5 canvas from a sprite
// sheet, tweened with GSAP. Adapted from skiper-ui.com/v1/skiper39
// (characters from openpeeps.com, original idea by codepen.io/zadvorsky).
export const CrowdCanvas = ({ src, rows = 15, cols = 7, className }: CrowdCanvasProps) => {
